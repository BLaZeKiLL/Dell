...
def getGlobalLevelSalesData_json() :
    file_name = os.getcwd() + "\\python\\GlobalLevel_json.pickle"
...
def getRegionWiseSalesData_json() :
    file_name = os.getcwd() + "\\python\\RegionWise_json.pickle"
    with open(file_name, "rb") as pickle_file :
        sales_json = pickle.load(pickle_file)
...
def getRegion_generationWiseSalesData_json() :
    file_name = os.getcwd() + "\\python\\RegionGenerationWise_json.pickle"
    with open(file_name, "rb") as pickle_file :
        sales_json = pickle.load(pickle_file)
...
def getGlobal_generationWiseSalesData_json() :
    file_name = os.getcwd() + "\\python\\GlobalGenerationWise_json.pickle"
    with open(file_name, "rb") as pickle_file :
        sales_json = pickle.load(pickle_file)
...
def getRegion_occupationWiseSalesData_json() :
    file_name = os.getcwd() + "\\python\\RegionOccupationWise_json.pickle"
    with open(file_name, "rb") as pickle_file :
        sales_json = pickle.load(pickle_file)
...
def getGlobal_occupationWiseSalesData_json() :
    file_name = os.getcwd() + "\\python\\GlobalOccupationWise_json.pickle"
    with open(file_name, "rb") as pickle_file :
        sales_json = pickle.load(pickle_file)
